    ...
    <>
      ...
      <div className="newUser">
        ...
        <div className="newUserItem">
            <label>Image</label>
            <input style={{border:"none"}} type="file" id="file" onChange={e=>setFile(e.target.files[0])}/>
          </div>
          <div className="newUserItem">
          ...
          <button onClick={inputs && file && handleClick} className="newUserButton">Create</button>
        </form>
      </div>
    </>
  );
